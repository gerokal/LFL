...
function validateRegisterForm(e) {
  ...
  //document.querySelector("#form-solo").reset();
...
// const regForm = document.querySelector("#form-solo");
// const errors_el = document.querySelector(".errors"); // Update the selector here

// regForm.addEventListener("submit", validateRegisterForm);

// function validateRegisterForm(e) {
//   //e.preventDefault(); // Uncomment this line if you want to prevent form submission
...
//     `Thank you for registering ${fname.value}!. We will contact you shortly.`
//   );
//   document.querySelector("#form-solo").reset(); // Add "#" before form ID
//   return true;
// }
